sap.ui.define([
	...
	return Controller.extend("project2.project2.controller.MasterBlockVersion", {
    formatter: formatter,
    ...
    onInit: function () {
      ...
      this._studentBlockModel = new JSONModel();
    },
    ...
    _onBindingDataReceivedListener: function(oEvent) {
      ...
      this._studentBlockModel.setData(oResultData);
      this.byId("idStudentBlockData").setModel(this._studentBlockModel, "StudentBlockData");
    },
