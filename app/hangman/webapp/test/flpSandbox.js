						...
						"inbounds": {
							"Hangman-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Project.Hangman.hangman",
									"url": sap.ui.require.toUrl("Project/Hangman/hangman")
								}
							}
						}
					}
